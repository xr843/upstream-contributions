...
| [haidian](https://github.com/open-city-ai/haidian) |  | [#2533](https://github.com/open-city-ai/haidian/pull/2533) | feat(two-way-line): 让「对开协议」在展示页里当场跑起来——页内实时推演 + 可亲手弄红的闸门 (v1.9) |
| [haidian](https://github.com/open-city-ai/haidian) |  | [#2527](https://github.com/open-city-ai/haidian/pull/2527) | fix(two-way-line): 修复 5 条无法解析的证据引用、§11 画像数自相矛盾，并补齐空缺的前提与自检证据层 (v1.8) |
| [haidian](https://github.com/open-city-ai/haidian) |  | [#1327](https://github.com/open-city-ai/haidian/pull/1327) | feat(two-way-line): verified sources, disclosed scope facts, rebuilt ... |
| [haidian](https://github.com/open-city-ai/haidian) |  | [#1227](https://github.com/open-city-ai/haidian/pull/1227) | feat(two-way-line): logo, recomputable Two-Way Protocol, and key-area... |
| [haidian](https://github.com/open-city-ai/haidian) |  | [#1216](https://github.com/open-city-ai/haidian/pull/1216) | fix(two-way-line): persist real four-gate self-check evidence (#883/#... |
| [haidian](https://github.com/open-city-ai/haidian) |  | [#914](https://github.com/open-city-ai/haidian/pull/914) | Submit jingzhang-two-way-line: 京张对开 THE TWO-WAY LINE (formal, xr843) |
